...
and the GPU tables of [performance.md](performance.md), measured on a 96-core Threadripper 7995WX and
two RTX 4500 Ada; `scripts/gen_results_figure.py` redraws it.*
