...
| [V-JEPA 2-AC ViT-g](https://dl.fbaipublicfiles.com/vjepa2/vjepa2-ac-vitg.pt) | 1.32 B | **action-conditioned world model**: encode a frame, roll out candidate action sequences, score them by the planning energy | MIT |
