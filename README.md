...
*Every number on it is read from `tests/results/{benchmarks,accuracy-image,accuracy-video,accuracy-ssv2}.json`
and the GPU tables of [docs/performance.md](docs/performance.md), measured on a 96-core Threadripper
7995WX and two RTX 4500 Ada; `scripts/gen_results_figure.py` redraws it.*
